...
import { homeOutline, pawOutline, pencilOutline, qrCodeOutline, schoolOutline } from 'ionicons/icons';
...
export class FooterComponent {
  ...
  constructor() { 
    addIcons({ homeOutline, qrCodeOutline, pawOutline, pencilOutline, schoolOutline });
  }
