...
private intervalId: any;
  ...
  ////////////////para que funcione el refrescar cada 3 segundo

  private startRefreshingPosts(): void {
    this.refreshPostList(); //llama al inicio
    this.intervalId = setInterval(() => {
      this.refreshPostList();
    }, 3000);
  }

//////////////////para que funcione el refresacar cada 3 segundo
